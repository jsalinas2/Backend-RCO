package com.pierrecode.debtcontrolapi.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        ValidationErrorDetails errorDetails = new ValidationErrorDetails(new Date(), "Error de validación",
    ...
    // Clase interna para detalles de error de validación
